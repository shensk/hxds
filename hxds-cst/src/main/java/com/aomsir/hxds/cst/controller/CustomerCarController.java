...
import com.aomsir.hxds.cst.controller.form.DeleteCustomerCarByIdForm;
import com.aomsir.hxds.cst.controller.form.InsertCustomerCarForm;
import com.aomsir.hxds.cst.controller.form.SearchCustomerCarListForm;
...
public class CustomerCarController {
    ...
    public R insertCustomerCar(@RequestBody @Valid InsertCustomerCarForm form) {
        ...
        this.customerCarService.insertCustomerCar(entity);
        return R.ok();
    }
    ...
    public R searchCustomerCarList(@RequestBody @Valid SearchCustomerCarListForm form) {
        ArrayList<HashMap> list = this.customerCarService.searchCustomerCarList(form.getCustomerId());
        return R.ok()
                .put("result", list);
    }
    ...
    public R deleteCustomerCarById(@RequestBody @Valid DeleteCustomerCarByIdForm form) {
        int rows = this.customerCarService.deleteCustomerCarById(form.getId());
        return R.ok()
                .put("rows", rows);
    }
}
